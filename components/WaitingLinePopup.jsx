  ...
  return (
    <Popup open={isOpen} onClose={handleClosePopup} modal nested>
     ...
     w-full p-10 shadow preview z-100  justify-center font-bold flex flex-col bt "
      >
        <h1 className="text-5xl text-[#2E2E2E] text-center">
          We're Almost There!
        </h1>
        <p className="text-lg break-words  mt-[1.8vh] text-[#2E2E2E] text-center font-[300]">
          Discover Ownboon, the ultimate ai platform for personal growth and
          productivity. <br /> Join the waitlist today!
        </p>
