export default function Hero() {
  return (
    <>
      ...
      <div className="flex flex-col h-[75%] xs:p-5 z-100 my-0 mx-0 items-center  justify-center">
        ...
        <div className="py-[6vh] md:text-[1.5rem] text-md font-normal justify-center text-center">
